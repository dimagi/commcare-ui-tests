...
APK_FILE = "build/outputs/apk/commcare-odk-commcare-debug.apk"
ODK_DIR = "commcare-odk"


def run(running_dir, pr_number):
    parent_dir = os.path.abspath("../")
    checkout_pr_branch(parent_dir, pr_number, "commcare-odk", "commcare")
    checkout_pr_branch(parent_dir, pr_number, "commcare-odk", "javarosa")
...
def main():
    ...
    # odk/javarosa/commcare dirs are all share the same parent dir, one level
    # up
